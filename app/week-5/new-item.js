...
export default function NewItemForm() {
    ...
    return(
        <form onSubmit={handleSubmit} className="space-y-4 p-6 bg-gray-800 rounded-lg shadow-md max-w-md mx-auto">
            <div>
            ...
            <div className="flex items-center space-x-2">
                <div className="flex items-center space-x-2">
                    <p >{quantity}</p>
                    <button onClick={Decrement} disabled={quantity===1} className="bg-gray-600 text-white p-2 rounded-md disabled:opacity-50">-</button>
                    <button onClick={Increment} disabled={quantity===20} className="bg-blue-500 text-white p-2 rounded-md disabled:opacity-50">+</ button>
                </div>
            </div>
